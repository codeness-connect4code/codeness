package com.connect.codeness.domain.news.controller;
...
public class NewsController {
	...
	@GetMapping
	public ResponseEntity<CommonResponseDto<PaginationResponseDto<NewsResponseDto>>> findNews(
		@RequestParam(defaultValue = PAGE_NUMBER) int pageNumber,
		@RequestParam(defaultValue = PAGE_SIZE) int pageSize
	) {
		CommonResponseDto<PaginationResponseDto<NewsResponseDto>> responseDto
